            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.jenis-hewan.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            <label for="nama_jenis_hewan" class="form-label">Nama Jenis Hewan <span clas="text-danger">*</span></label>
                            <input type="text"
                                    class="form-controll @error('nama_jenis_hewan') is-invalid @enderror"
                                    id="nama_jenis_hewan"
